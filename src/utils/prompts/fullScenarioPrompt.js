...
Return ONLY a valid JSON object with this EXACT structure:
{
  ...
  "productName": "Catchy, memorable name of the program/product/service — coherent with the industry and buyer persona generated above",
...
Devolvé ÚNICAMENTE un objeto JSON válido con esta estructura EXACTA:
{
  ...
  "productName": "Nombre llamativo y memorable del programa/producto/servicio — coherente con la industria y el buyer persona generados arriba",
