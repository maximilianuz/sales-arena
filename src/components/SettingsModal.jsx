          ...
          <>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginTop: '0.5rem' }}>
                Los datos se guardan localmente. Por defecto usa la API de NVIDIA NIM, pero puedes usar OpenAI, Groq, OpenRouter o cualquier API compatible con el formato OpenAI configurando la URL y el Modelo.
              </p>
            </div>
          </>
        )}
