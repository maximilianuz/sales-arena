...
export default function PipelinePanel({ activeStageIndex, setActiveStageIndex, pipelineQuestions, stages, isFree, onUpgradeStage }) {
  ...
  return (
    <div className="glass-panel" style={{ padding: '1rem', marginBottom: '1rem' }}>
      ...
      <div className="pipeline-detail" style={{ display: 'flex', gap: '1.5rem', background: 'rgba(0,0,0,0.2)', padding: '1.5rem', borderRadius: '1rem', border: '1px solid var(--glass-border)' }}>
        <div style={{ flex: 1 }}>
        ...
        <div className="pipeline-detail-side" style={{ flex: 1, borderLeft: '1px solid var(--glass-border)', paddingLeft: '1.5rem', display: 'flex', flexDirection: 'column' }}>
        ...
        {setActiveStageIndex && (
          <div className="pipeline-nav" style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', justifyContent: 'center' }}>
